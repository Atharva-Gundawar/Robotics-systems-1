            ...
            while True:
                ...
                for result in results:
                    ...
                    for i in range(detection_count):
                        ...
                        # plt.text(x, y, label, color='r', fontsize=8, bbox=dict(facecolor='white', alpha=0.7))

                        # # Show the plot
                        # plt.show()

                # if detect_result:
                #     x, y, input_img = detect_result # return center of detetcted result and image with anootations
